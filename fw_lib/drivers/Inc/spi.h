...
void CLIC_SPI1_IRQhandler(void) __attribute__((interrupt("SiFive-CLIC-preemptible")));//SPI1 中断函数
void CLIC_SPI2_IRQhandler(void) __attribute__((interrupt("SiFive-CLIC-preemptible")));//SPI2 中断函数

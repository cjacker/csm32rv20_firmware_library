...
//中断处理函数
void CLIC_I2C_ready_IRQhandler(void) __attribute__((interrupt("SiFive-CLIC-preemptible")));
void CLIC_I2C_error_IRQhandler(void) __attribute__((interrupt("SiFive-CLIC-preemptible")));

...
void CLIC_UART1_IRQhandler(void) __attribute__((interrupt("SiFive-CLIC-preemptible")));
void CLIC_UART2_IRQhandler(void) __attribute__((interrupt("SiFive-CLIC-preemptible")));
void CLIC_UART3_IRQhandler(void) __attribute__((interrupt("SiFive-CLIC-preemptible")));
void CLIC_UART4_IRQhandler(void) __attribute__((interrupt("SiFive-CLIC-preemptible")));

...
void GPIO_EXTI_Init_case1(GPIO_TypeDef *GPIOx, uint8_t PINx)//检测高电平
{
    ...
    GPIO_EXTI_MODE_Init(GPIOx, PINx, GPIO_EXTI_HIGNLEVEL);
...
{
    GPIO_MODE_Init(GPIOx, PINx, GPIO_MODE_INPUT);
    GPIO_EXTI_MODE_Init(GPIOx, PINx, GPIO_EXTI_LOWLEVEL);
    GPIO_PULL_Init(GPIOx, PINx, GPIO_PULLUP);
    GPIO_INTER_enable(GPIOx, PINx);
}
...
{
    GPIO_MODE_Init(GPIOx, PINx, GPIO_MODE_INPUT);
    GPIO_EXTI_MODE_Init(GPIOx, PINx, GPIO_EXTI_RISING);
    GPIO_PULL_Init(GPIOx, PINx, GPIO_PULLUP);
    GPIO_INTER_enable(GPIOx, PINx);
}
...
{
    GPIO_MODE_Init(GPIOx, PINx, GPIO_MODE_INPUT);
    GPIO_EXTI_MODE_Init(GPIOx, PINx, GPIO_EXTI_FALLING);
    GPIO_PULL_Init(GPIOx, PINx, GPIO_PULLUP);
    GPIO_INTER_enable(GPIOx, PINx);
}
